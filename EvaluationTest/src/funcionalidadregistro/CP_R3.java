...
public class CP_R3 {
	public static void main(String[] args) {
		...
		//Ingresar el correo
		driver.findElement(By.xpath("//input[@id='email_create']")).sendKeys("testfernando3@test.com");
		
		//Click en el botón "Create an account"
		driver.findElement(By.xpath("//button[@name=\"SubmitCreate\"]")).click();
		
		//Ingresar la información personal faltando el campo company ni el campo phone number
		...
		//Validar que el usuario ha sido creado
		  if(userText.contains("Tester")) {
		   ...
		   System.out.println("Fallo la verificación del usuario, prueba insatisfactoria");
		  }
	}
